...
| `settings.target`    | Default operating system: `linux` when omitted, or `windows/wsl2`, `windows/normal`, or `macos` with Crabbox 0.53.1 or newer. A placement can supply `os`; unsupported values are rejected.                                                                                                                                                                                                                                                                                                                                                |

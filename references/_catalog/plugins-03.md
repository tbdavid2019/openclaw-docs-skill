...
- [Fish Audio plugin](../plugins/reference/fish-audio.md) — Fish Audio S2.1 hosted text-to-speech with streaming, voice notes, and telephony output. Read when: You are installing, configuring, or auditing the fish-audio plugin.

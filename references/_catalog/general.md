...
- [Docs map source](../docs_map.md) — Source stub for the generated docs map. Read when: Finding which docs page covers a topic before reading the page.
...
- [OpenClaw](../index.md) — OpenClaw is an open-source AI assistant that runs on your own hardware and meets you in every chat app you already use. Read when: Introducing OpenClaw to newcomers.

...
- [Session Dashboards](../web/dashboards.md) — Session dashboards: agent-built widgets, boards, tabs, and the dashboard side panel. Read when: Using or explaining session dashboards in the Control UI; Deciding what agents can do on a board and what needs an operator grant.

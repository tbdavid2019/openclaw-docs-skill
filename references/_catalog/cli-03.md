...
- [Triage](../cli/triage.md) — CLI reference for `openclaw triage` (sanitized diagnostics and agent handoff). Read when: OpenClaw is misbehaving and you want an agent-ready debugging prompt; You need a sanitized diagnostics bundle without applying repairs.

...
- [Usage telemetry and update checks](../gateway/telemetry.md) — Daily update requests, approximate location, optional anonymous feature statistics, and privacy controls. Read when: Checking what OpenClaw sends and what the receiver stores; Deciding whether to share anonymous feature statistics; Enabling or disabling anonymous feature statistics; Disabling all automatic update-check requests.

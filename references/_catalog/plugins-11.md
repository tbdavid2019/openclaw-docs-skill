...
- [Webhooks plugin reference](../plugins/reference/webhooks.md) — Authenticated inbound webhooks that bind external automation to OpenClaw TaskFlows. Read when: You are installing, configuring, or auditing the webhooks plugin.
...
- [Zoom meetings plugin reference](../plugins/reference/zoom-meetings.md) — Join Zoom meetings as a Chrome browser guest. Read when: You are installing, configuring, or auditing the zoom-meetings plugin.
